...
- (NSDictionary *)fecthAddDeviceParams{
    NSString *message = @"Keep the device energized and confirm that indicator is blinking blue";
    NSString *gifName = @"addDevice_centerSensorGif";
    NSString *linkMessage = @"My light is not blinking blue";
    NSString *blinkButtonTitle = @"Indicator blink blue light";
    CGFloat gifWidth = 200.f;
    CGFloat gifHeight = 200.f;
...
- (NSDictionary *)fecthNotBlinkParams{
    ...
    NSString *buttonTitle = @"Indicator blink blue light";
    return @{
...
- (NSArray *)fecthNotBlinkAmberDataSource{
    ...
    NSDictionary *step2Dic = @{
                               @"stepMsg":@"Step 2",
                               @"operationMsg":@"Hold the button for 10s until the LED blink blue",

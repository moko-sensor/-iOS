...
- (UIButton *)cancelButton{
    if (!_cancelButton) {
        ...
        [_cancelButton setTitleColor:NAVIGATION_BAR_COLOR forState:UIControlStateNormal];
...
- (UIButton *)confirmButton{
    if (!_confirmButton) {
        ...
        [_confirmButton setTitleColor:NAVIGATION_BAR_COLOR forState:UIControlStateNormal];

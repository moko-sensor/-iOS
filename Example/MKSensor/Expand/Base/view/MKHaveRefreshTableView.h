...
@class MKHaveRefreshTableView;

@protocol MKHaveRefreshTableViewDelegate <NSObject>

@optional
/**
 *  footer开始刷新执行的方法（写刷新逻辑）
 */
- (void)refreshTableView:(MKHaveRefreshTableView *)tableView footerBeginRefreshing:(UIView *)footView;
...
@interface MKHaveRefreshTableView : MKBaseTableView
{
    @package
...
// 上拉下拉刷代理
@property (nonatomic,assign)id <MKHaveRefreshTableViewDelegate>refreshDelegate;

...
- (void)viewDidLoad
{
    ...
    if (_naviType == GYNaviTypeHide)
        {
        _customNaviView = [[MKCustomNaviView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, 64)];
        ...
        [_customNaviView.leftButton.titleLabel setFont:MKFont(16)];
        ...
        [_customNaviView.rightButton.titleLabel setFont:MKFont(16)];
